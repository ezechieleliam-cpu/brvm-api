    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_1 = _a.sent();
                    console.error('❌ [Mongoose] Erreur :', err_1.message);
                    return [3 /*break*/, 5];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('❌ [MongoClient] Erreur :', error_1);
                    return [3 /*break*/, 7];
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, testMongoose()];
            case 1:
                _a.sent();
                return [4 /*yield*/, testNativeMongo()];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
